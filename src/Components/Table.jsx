...
let counter = 0;
function createData(name, email, userID) {
    counter += 1;
    return { id: counter, name, email, userID};
}
...
class EnhancedTable extends React.Component {
    // createData('Cupcake', 'dfgh@convertHexToRGB.com', 'dfg9dfg7')
    state = {
        order: 'asc',
        orderBy: 'email',
        selected: [],
    ...
    // Collect the data from Database and listen to changes
    componentDidMount = async () => {
        ...
        setTimeout(() => {
            console.log('Users fetched from Firebase: ', this.state.data);
        }, 2000);

    };
    // remove the listener from above
